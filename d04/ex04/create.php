...
if (jr_isset($_POST, 'login') && jr_isset($_POST, 'passwd') && jr_isset($_POST, 'submit')){
	if ($_POST['login'] !== '' && $_POST['passwd'] !== '' && $_POST['submit'] === 'OK' && !jr_isset($users_array, $_POST['login'])){
		$users_array[$_POST['login']] = array('login'=>$_POST['login'], 'passwd'=>do_hash($_POST['passwd'], $_POST['login']));
